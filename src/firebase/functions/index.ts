 ...
 */
export const processPlayerData = (data: ProcessPlayerDataParams): ProcessPlayerDataResult => {
 ...
 */
export const generateCardPack = (_data: {
  packType: string;
 ...
 */
export const updateUserCollection = (data: {
  userId: string;
 ...
 */
export const calculateLineupPoints = (data: {
  userId: string;
  lineupId: string;
