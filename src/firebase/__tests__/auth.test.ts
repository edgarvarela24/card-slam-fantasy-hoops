...
import { signIn, signUp, logout, resetPassword, getCurrentUser, onAuthChange } from '../auth';
...
describe('Firebase Authentication', () => {
  ...
  test('getCurrentUser returns current user from auth', () => {
    ...
    jest.requireMock('../firebase').getFirebaseAuth = jest
      .fn()
      .mockReturnValue({ currentUser: mockUser });
